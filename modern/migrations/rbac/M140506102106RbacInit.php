 ...
 * @since 2.0
 */
class M140506102106RbacInit extends \yii\db\Migration
{
    /**
    ...
    public function up()
    {
        ...
        $schema = $this->db->schemaMap['pgsql']['defaultSchema'] . ".";
    ...
    public function down()
    {
        ...
        $this->dropTable($schema . $authManager->assignmentTable);
        $this->dropTable($schema . $authManager->itemChildTable);
        $this->dropTable($schema . $authManager->itemTable);
        $this->dropTable($schema . $authManager->ruleTable);
    }
